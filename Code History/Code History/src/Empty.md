...
This file contains the api functions in .py 
...
import uuid
from API.BaseModels import ClothingItemBase, Outfit, ColorPalette
import logging
...
async def add_item(item: ClothingItemBase, request: Request):
    try:
        # need to modify WardrobeManager.add_item() to accept parameters
